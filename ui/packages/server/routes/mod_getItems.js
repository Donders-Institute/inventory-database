...
var _getItems = function (req, res) {
    ...
    const sql = `SELECT 
        ...
        u.email, 
        i.room_id, 
        r.technical_room_number, 
        i.project_code, 
        i.order_number, 
        i.supplier, 
        i.date_of_supply, 
        i.guarantee_period, 
        i.date_out_of_guarantee, 
        i.last_audit, 
        i.purchase_value, 
        i.hostname, 
        i.ram_memory, 
        ...
        i.manufacturer 
        FROM items 
        AS i INNER JOIN users AS u ON i.user_id =  u.id 
        INNER JOIN rooms as r ON r.id = i.room_id 
        INNER JOIN product_types AS p ON p.id = i.product_type_id`;
...
module.exports.getItems = _getItems;